...
from components.orchestrator import mgo_ctx_v1, mgo_v1
...
async def handle_user_input(agent: mgo_v1, message: str):
...
def main():
    ...
    if "agent" not in st.session_state:
        ...
        if "context" not in st.session_state:
            st.session_state.context = mgo_ctx_v1(
