...
from components.orchestrator import mgo_ctx_v2, mgo_v2
...
async def handle_user_input(agent: mgo_v2, message: str):
...
def main():
    ...
    if "agent" not in st.session_state:
        ...
        if "context" not in st.session_state:
            st.session_state.context = mgo_ctx_v2(
